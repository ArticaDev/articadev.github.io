$(function () {
  ...
  $(".navbar-nav li a").click(function () {
    $("html, body").animate(
      {
        scrollTop:
          Math.abs($("#home-section").offset().top) +
          $("#" + $(this).data("section")).offset().top -
          100,
      },
      "100"
    );
  ...
  $("#emailIcon").click(function () {
    ...
    $('#emailIcon[data-toggle="tooltip"]')
      .attr("data-original-title", "O nosso email foi copiado :)")
      .tooltip("dispose")
      .tooltip("show");
  });
  ...
  $(".form-group input, .contact-form textarea").on("keyup", function () {
    ...
    if (empty) $(".contact-form button").attr("disabled", "disabled");
    else {
